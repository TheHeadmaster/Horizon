...
/// <remarks>
/// <para>
/// This class is a <see cref="Window" /> that is also reactive. That is, it implements <see cref="IViewFor{T}" />. You can
/// extend this class to get an implementation of <see cref="IViewFor{TViewModel}" /> rather than writing one yourself.
/// </para>
/// <para>
/// Note that the XAML for your control must specify the same base class, including the generic argument you provide for your
/// view model. To do this, use the <c>TypeArguments</c> attribute as follows:
/// <code>
///<![CDATA[
///<rxui:ReactiveWindow
...
/// </para>
/// </remarks>
/// <typeparam name="TViewModel">The type of the view model backing the view.</typeparam>
